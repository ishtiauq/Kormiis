...
export function DatePicker({ label, value, onChange, className, required, ...props }) {
  ...
  return (
    ...
    >
      ...
      <Group className="flex h-10 w-full items-center rounded-xl border border-input bg-transparent text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring transition-all cursor-text">
      ...
      <AriaPopover className="z-50 animate-in fade-in-0 zoom-in-95 origin-top rounded-2xl glass-kormiis glass-popover text-popover-foreground shadow-none p-0 overflow-hidden" offset={8}>
