...
export function DatePicker({ label, value, onChange, className, required, ...props }) {
  ...
  return (
    ...
    >
      ...
      <AriaPopover className="z-50 animate-in fade-in-0 zoom-in-95 origin-top rounded-2xl border-none glass-kormiis text-popover-foreground shadow-2xl p-0 overflow-hidden" offset={8}>
