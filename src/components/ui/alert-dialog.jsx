...
const AlertDialogContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <AlertDialogOverlay>
    <AriaModal
      ref={ref}
      className={cn(
        "w-full max-w-md flex flex-col overflow-hidden rounded-[28px] glass-kormiis-modal text-card-foreground shadow-none transition-all duration-200 data-[entering]:animate-in data-[entering]:zoom-in-95 data-[exiting]:animate-out data-[exiting]:zoom-out-95 p-0 relative",
        className
      )}
      {...props}
    >
