...
export default function GlassMonthPicker({
  ...
  return (
    <div ref={containerRef} className={`relative inline-flex items-center gap-1.5 ${className}`}>
      ...
      {isOpen && (
        <div
          className={`glass-kormiis glass-popover absolute top-full mt-2 z-[9999] w-[270px] sm:w-[285px] p-4 text-foreground shadow-none rounded-[24px] overflow-hidden animate-in fade-in-0 zoom-in-95 duration-200 ${
