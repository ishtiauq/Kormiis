  ...
  return (
    <TabPrimitive
      ...
      className={cn(
        ...
        "data-selected:bg-neutral-900 data-selected:text-white dark:data-selected:bg-white dark:data-selected:text-neutral-900 data-selected:shadow-none font-semibold",
