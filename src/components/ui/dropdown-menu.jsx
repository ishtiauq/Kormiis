...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenu
      ...
      className={cn(
        "w-auto min-w-36 rounded-3xl p-1.5 text-popover-foreground shadow-none border border-border glass-kormiis glass-popover duration-100 **:data-[slot$=-item]:focus:bg-foreground/10 **:data-[slot$=-item]:data-highlighted:bg-foreground/10 **:data-[slot$=-separator]:bg-foreground/5 **:data-[slot$=-trigger]:focus:bg-foreground/10 **:data-[slot$=-trigger]:aria-expanded:bg-foreground/10! **:data-[variant=destructive]:focus:bg-foreground/10! **:data-[variant=destructive]:text-accent-foreground! **:data-[variant=destructive]:**:text-accent-foreground!",
        className
      )}
      placement={placement}
      crossOffset={crossOffset}
