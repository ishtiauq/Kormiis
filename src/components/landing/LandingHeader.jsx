        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {deferredPrompt && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-[#141416] hover:bg-[#1f1f23] text-[#bbbbbb] hover:text-white border border-white/10 transition-colors"
          ...
          <button
            ...
            className="px-4 py-2 rounded-full text-xs sm:text-sm font-semibold text-[#bbbbbb] hover:text-white hover:bg-[#141416] transition-colors"
          >
            Sign in
          </button>
